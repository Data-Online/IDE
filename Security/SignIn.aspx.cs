...
#region "Section 2: Do not modify this section."
   ...
   #region " Misc Methods "
        ...
        get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InvalidLoginInfo", "IDE"); }
        }


        public string ERR_INTERNAL_ERROR {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InternalErrorLogin", "IDE"); }
        }


        public string LOGIN_MSG {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsg", "IDE"); }
        }


        public string LOGIN_MSG_SESSION_INVALID {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsgSessionInvalid", "IDE"); }
        }
   #endregion
