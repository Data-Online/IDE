...
</td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0" style="width: 100%;"><tr><td></td><td class="prbbc"></td><td class="prbbc"></td><td></td><td class="prbbc"></td><td class="prspace"></td><td class="prbbc" style="text-align:right"></td><td class="prbbc" style="text-align:right">
...
<asp:Literal runat="server" id="PdfFileName" Text="MyLiteral">	</asp:Literal></td><td class="tableCellLabel"><asp:Image runat="server" id="UploadedOkImage" height="35px" imageurl="../Images/uploadedOk.png" tooltip="File uploaded OK" visible="False">		
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CancelButton"))%>
	...
	</asp:ImageButton>  <span style="font-size:8pt"><asp:Literal runat="server" id="Meridian" Text="Meridian">	</asp:Literal> </span>
<asp:ImageButton runat="server" id="EditRowButton1" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_edit.gif" onmouseout="this.src=&#39;../Images/icon_edit.gif&#39;" onmouseover="this.src=&#39;../Images/icon_edit_over.gif&#39;" tooltip="Edit Using Contact Template">		
	</asp:ImageButton> <span style="font-size:8pt"><asp:Literal runat="server" id="Contact" Text="Contact">	</asp:Literal></span> 
<asp:ImageButton runat="server" id="EditRowButton2" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_edit.gif" onmouseout="this.src=&#39;../Images/icon_edit.gif&#39;" onmouseover="this.src=&#39;../Images/icon_edit_over.gif&#39;" tooltip="Edit Using Mercury Template">		
	</asp:ImageButton> <span style="font-size:8pt"><asp:Literal runat="server" id="Mercury" Text="Mercury">	</asp:Literal></span>
...
</td><td class="tableCellLabel" style="font-size:10pt"></td><td class="tableCellLabel"><asp:Literal runat="server" id="SiteIdLabel" Text="Site" visible="True">	</asp:Literal> 
