<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-InvoiceSummaries-Meridian.aspx.cs" Culture="en-GB" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IDE.UI.Edit_InvoiceSummaries_Meridian" %>
...
<%@ Register Tagprefix="IDE" Namespace="IDE.UI.Controls.Edit_InvoiceSummaries_Meridian" Assembly="IDE" %>
...
<asp:Literal runat="server" id="PdfFileName" Text="MyLiteral">	</asp:Literal></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:label id="CompanyType" runat="server" text="Meridian Energy Template"></asp:label></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ConnectionNumberTextBoxMaxLengthValidator" ControlToValidate="ConnectionNumber" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Connection Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="SupplierIdLabel" Text="Supplier">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="SupplierId" redirecturl=""></BaseClasses:QuickSelector></td><td class="tableCellLabel" style="color:Red;text-align:left;" rowspan="8" colspan="2"><asp:literal id="Alert" runat="server" text="AlertZZZ"></asp:literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustomerNumberLabel" Text="Customer Number" visible="False">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CustomerNumberTextBoxMaxLengthValidator" ControlToValidate="CustomerNumber" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Customer Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceTotalLabel" Text="Invoice Total">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceTotalTextBoxMaxLengthValidator" ControlToValidate="InvoiceTotal" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Total&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceDueDateLabel" Text="Invoice Due Date">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceDueDateTextBoxMaxLengthValidator" ControlToValidate="InvoiceDueDate" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Due Date&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="GstTotalLabel" Text="GST Total">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceDateLabel" Text="Invoice Date">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceDateTextBoxMaxLengthValidator" ControlToValidate="InvoiceDate" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Date&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="AccountNumberLabel" Text="Account Number">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="AccountNumberTextBoxMaxLengthValidator" ControlToValidate="AccountNumber" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Account Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceNumberLabel" Text="Invoice Number">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceNumberTextBoxMaxLengthValidator" ControlToValidate="InvoiceNumber" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="SiteIdLabel" Text="Site" visible="True">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="SiteId" redirecturl="" visible="True"></BaseClasses:QuickSelector> </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="ConnectionNumberLabel" Text="ICP Number">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="EnergyPointId" redirecturl=""></BaseClasses:QuickSelector></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="KWhTotalLabel" Text="EvaluateFormula(&quot;= \&quot;kWh Total\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="EnergyChargesTotalLabel" Text="Energy Charges Total" visible="False">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="EnergyChargesTotalTextBoxMaxLengthValidator" ControlToValidate="EnergyChargesTotal" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Energy Charges Total&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="NetworkChargesTotalLabel" Text="Network Charges Total" visible="False">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="NetworkChargesTotalTextBoxMaxLengthValidator" ControlToValidate="NetworkChargesTotal" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Network Charges Total&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="MiscChargesTotalLabel" Text="Other Charges Total" visible="False">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
 ...
 <BaseClasses:TabPanel runat="server" id="TabPanel" HeaderText="Energy Charges">	<ContentTemplate> 
  <IDE:EnergyChargesTableControl runat="server" id="EnergyChargesTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
            ...
            <IDE:ThemeButtonWithArrow runat="server" id="Filters2Button" button-causesvalidation="False" button-commandname="Custom" button-onclientclick="return ISD_ShowPopupPanel(&#39;Filters2Div&#39;,&#39;Filters2Button&#39;,this);" button-text="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;IDE&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;IDE&quot;) %>"></IDE:ThemeButtonWithArrow>
                  ...
                  <asp:panel id="CollapsibleRegion2" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="EnergyChargesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="2"><asp:CheckBox runat="server" id="ToggleAll2" onclick="toggleAllCheckboxes(this);" visible="False">	</asp:CheckBox></th><th class="thcnb">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th></tr><asp:Repeater runat="server" id="EnergyChargesTableControlRepeater">		<ITEMTEMPLATE>		<IDE:EnergyChargesTableControlRow runat="server" id="EnergyChargesTableControlRow">
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" colspan="4" style="text-align:center;font-weight:bold;color:#0080FF;">Non Business Day</td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" colspan="2" style="text-align:center;font-weight:bold;">Rate</td><td class="tableCellLabel" colspan="2" style="text-align:center;font-weight:bold;">Amount</td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" rowspan="20" colspan="2">
                        ...
                        </td><td class="tableCellLabel"><asp:Literal runat="server" id="NBD0004Label" Text="EvaluateFormula(&quot;= \&quot;Weekend 0000 - 0400\&quot;&quot;, true)">	</asp:Literal> 
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="NBD2024TextBoxMaxLengthValidator" ControlToValidate="NBD2024" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Weekend 2000 - 2400\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total1" runat="server" text="Total"></asp:label></td><td class="tableCellLabel" style="text-align:left;"><asp:literal id="Literal5" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel" colspan="4" style="text-align:center;font-weight:bold;color:#0080FF;">Business Day</td></tr><tr><td class="tableCellLabel" style="text-align:center;font-weight:bold;"><asp:Literal runat="server" id="BDQ0004Label" Text="EvaluateFormula(&quot;= \&quot;Quantity 00:00 - 00:04\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td><td class="tableCellLabel" style="text-align:center;font-weight:bold;"><asp:Literal runat="server" id="BDL0004Label" Text="EvaluateFormula(&quot;= \&quot;Losses 00:00 - 00:04\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td></tr><tr><td class="tableCellLabel" colspan="2" style="text-align:center;font-weight:bold;">Rate</td><td class="tableCellLabel" colspan="2" style="text-align:center;font-weight:bold;">Amount</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="BD0004Label" Text="EvaluateFormula(&quot;= \&quot;Weekday 0000 - 0400\&quot;&quot;, true)">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="BD2024TextBoxMaxLengthValidator" ControlToValidate="BD2024" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Weekday 2000 - 2400\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total2" runat="server" text="Total"></asp:label></td><td class="tableCellValue" style="text-align:left;"><asp:literal id="Literal6" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel" style="text-align:left;font-weight:bold;color:#00FF40;"></td><td class="tableCellLabel" style="text-align:left;font-weight:bold;color:#00FF40;"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total4" runat="server" text="Page Total"></asp:label></td><td class="tableCellLabel" style="text-align:left;"><asp:literal id="Literal8" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel" colspan="4" style="text-align:left;font-weight:bold;color:#00FF40;"><asp:literal id="Literal2" runat="server" text="Refer to 'Other Data' tab for Service Charges/EA Charge data entry"></asp:literal></td></tr><tr><td class="tableRowDivider" colspan="7"></td></tr></IDE:EnergyChargesTableControlRow>
</ITEMTEMPLATE>
 ...
 <BaseClasses:TabPanel runat="server" id="TabPanel1" HeaderText="Network Charges">	<ContentTemplate> 
  <IDE:NetworkChargesTableControl runat="server" id="NetworkChargesTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
            ...
            <IDE:ThemeButtonWithArrow runat="server" id="Filters1Button" button-causesvalidation="False" button-commandname="Custom" button-onclientclick="return ISD_ShowPopupPanel(&#39;Filters1Div&#39;,&#39;Filters1Button&#39;,this);" button-text="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;IDE&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;IDE&quot;) %>"></IDE:ThemeButtonWithArrow>
                  ...
                  <asp:panel id="CollapsibleRegion1" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="NetworkChargesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="2"><asp:CheckBox runat="server" id="ToggleAll1" onclick="toggleAllCheckboxes(this);" visible="False">	</asp:CheckBox></th><th class="thcnb">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc"></th></tr><asp:Repeater runat="server" id="NetworkChargesTableControlRepeater">		<ITEMTEMPLATE>		<IDE:NetworkChargesTableControlRow runat="server" id="NetworkChargesTableControlRow">
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;" colspan="2">Network Charges Variable</td><td class="tableCellLabel" style="text-align:center;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;" colspan="2">Network Charges Fixed</td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" rowspan="4" colspan="2">
...
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="VariableNBD" Columns="19" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="VariableNBDRequiredFieldValidator" ControlToValidate="VariableNBD" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Variable Charge Non Business / Weekend\&quot;&quot;, true)) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="VariableNBDTextBoxMaxLengthValidator" ControlToValidate="VariableNBD" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Variable Charge Non Business / Weekend\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellLabel"></td><td class="tableCellLabel"><asp:Literal runat="server" id="CapacityChargeLabel" Text="Capacity Charge">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="VariableBDTextBoxMaxLengthValidator" ControlToValidate="VariableBD" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Variable Charge Business/Weekday\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellLabel"></td><td class="tableCellLabel"><asp:Literal runat="server" id="DemandChargeLabel" Text="Demand Charge">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="DemandChargeTextBoxMaxLengthValidator" ControlToValidate="DemandCharge" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Demand Charge&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel"></td><td class="tableCellLabel"><asp:Literal runat="server" id="FixedChargeLabel" Text="Fixed Charge">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="FixedChargeTextBoxMaxLengthValidator" ControlToValidate="FixedCharge" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Fixed Charge&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total" runat="server" text="Total"></asp:label></td><td class="tableCellValue" style="font-weight:bold"><asp:literal id="LineChargeSum" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="7"></td><td class="tableRowDivider"></td></tr></IDE:NetworkChargesTableControlRow>
</ITEMTEMPLATE>
 ...
 <BaseClasses:TabPanel runat="server" id="TabPanel2" HeaderText="Other Data">	<ContentTemplate> 
  <IDE:OtherChargesTableControl runat="server" id="OtherChargesTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  ...
                  <asp:panel id="CollapsibleRegion3" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="OtherChargesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="3"><asp:CheckBox runat="server" id="ToggleAll" onclick="toggleAllCheckboxes(this);" visible="False">	</asp:CheckBox></th><th class="thcnb"></th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc"></th><th class="thc"></th></tr><asp:Repeater runat="server" id="OtherChargesTableControlRepeater">		<ITEMTEMPLATE>		<IDE:OtherChargesTableControlRow runat="server" id="OtherChargesTableControlRow">
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" colspan="2" style="color:#0080FF;text-align:center;"><asp:literal id="Literal4" runat="server" text="Rate"></asp:literal></td><td class="tableCellLabel" colspan="2" style="color:#0080FF;text-align:center;"><asp:literal id="Literal3" runat="server" text="Charge"></asp:literal></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" rowspan="7" colspan="3">
                              <asp:CheckBox runat="server" id="SelectRow" onclick="moveToThisTableRow(this);" visible="False">	</asp:CheckBox>                              
                            </td><td class="tableRowButtonsCellVertical" rowspan="7">
                        ...
                        </td><td class="tableCellLabel"><asp:Literal runat="server" id="BDSVCLabel" Text="EvaluateFormula(&quot;= \&quot;Energy Service Charge Business Day (Weekday)\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="BDSVCR1" Columns="19" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="BDSVCR1RequiredFieldValidator" ControlToValidate="BDSVCR1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Business Day (Weekday) Service Rate\&quot;&quot;, true)) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="BDSVCR1TextBoxMaxLengthValidator" ControlToValidate="BDSVCR1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Business Day (Weekday) Service Rate\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="BDSVC1" Columns="19" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="BDSVC1RequiredFieldValidator" ControlToValidate="BDSVC1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Energy Service Charge Business Day (Weekday)\&quot;&quot;, true)) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="BDSVC1TextBoxMaxLengthValidator" ControlToValidate="BDSVC1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Energy Service Charge Business Day (Weekday)\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellLabel"><asp:Literal runat="server" id="AdminChargeLabel" Text="Other Charges Total">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="NBDSVCR1" Columns="19" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="NBDSVCR1RequiredFieldValidator" ControlToValidate="NBDSVCR1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Non Business Day (Weekend) Service Rate\&quot;&quot;, true)) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="NBDSVCR1TextBoxMaxLengthValidator" ControlToValidate="NBDSVCR1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Non Business Day (Weekend) Service Rate\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="NBDSVC1" Columns="19" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="NBDSVC1RequiredFieldValidator" ControlToValidate="NBDSVC1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Energy Service Charge NON Business Day (Weekend)\&quot;&quot;, true)) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="NBDSVC1TextBoxMaxLengthValidator" ControlToValidate="NBDSVC1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Energy Service Charge NON Business Day (Weekend)\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="EALevyRLabel1" Text="EvaluateFormula(&quot;= \&quot;Electricity Authority Rate / EA Levy Rate\&quot;&quot;, true)">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="EALevy1TextBoxMaxLengthValidator" ControlToValidate="EALevy1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Electricity Authority Charge / EA Levy\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total3" runat="server" text="Page Total"></asp:label></td><td class="tableCellValue"><asp:literal id="Literal7" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="8"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></IDE:OtherChargesTableControlRow>
</ITEMTEMPLATE>
