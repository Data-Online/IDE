...
// This file implements the code-behind class for Show_InvoiceSummaries_Table.aspx.
// Show_InvoiceSummaries_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_InvoiceSummaries_Table
        : BaseApplicationPage
// Code-behind class for the Show_InvoiceSummaries_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_InvoiceSummaries_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Show_InvoiceSummaries_Table.InvoiceSummariesTableControl InvoiceSummariesTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IDE.UI.Controls.Show_InvoiceSummaries_Table.InvoiceSummariesTableControl control = new IDE.UI.Controls.Show_InvoiceSummaries_Table.InvoiceSummariesTableControl();
