...
// This file implements the code-behind class for Edit_InvoiceSummaries_Meridian_Table.aspx.
// Edit_InvoiceSummaries_Meridian_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_InvoiceSummaries_Meridian_Table
        : BaseApplicationPage
// Code-behind class for the Edit_InvoiceSummaries_Meridian_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_InvoiceSummaries_Meridian_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Edit_InvoiceSummaries_Meridian_Table.InvoiceSummariesTableControl InvoiceSummariesTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Invoice Summaries");
      ...
      public void SaveData_Base()
      {
        ...
        this.InvoiceSummariesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IDE.UI.Controls.Edit_InvoiceSummaries_Meridian_Table.InvoiceSummariesTableControl control = new IDE.UI.Controls.Edit_InvoiceSummaries_Meridian_Table.InvoiceSummariesTableControl();
