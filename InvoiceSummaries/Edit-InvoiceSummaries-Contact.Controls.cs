...
// Edit_InvoiceSummaries_Contact.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Edit_InvoiceSummaries_Contact
{
    ...
    public class EnergyChargesTableControlRow : BaseEnergyChargesTableControlRow
    {
        ...
        public override void Validate()
        {
            ...
            //var totalBD = this.DataSource.BD0004 + this.DataSource.BD0408 + this.DataSource.BD0812 + this.DataSource.BD1216 + this.DataSource.BD1620 + this.DataSource.BD2024;
            //var totalNBD = this.DataSource.NBD0004 + this.DataSource.NBD0408 + this.DataSource.NBD0812 + this.DataSource.NBD1216 + this.DataSource.NBD1620 + this.DataSource.NBD2024;
            //var totalFromBill = (new InvoiceSummariesRecordControl { }).DataSource.EnergyChargesTotal - (new InvoiceSummariesRecordControl { }).DataSource.GstTotal;
    ...
    public class InvoiceSummariesRecordControl : BaseInvoiceSummariesRecordControl
    {
		...
		public override void SetInvoiceDueDate()
        {
...
// Base class for the EnergyChargesTableControlRow control on the Edit_InvoiceSummaries_Contact page.
...
// Base class for the EnergyChargesTableControl control on the Edit_InvoiceSummaries_Contact page.
...
public class BaseEnergyChargesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    IDE.UI.Controls.Edit_InvoiceSummaries_Contact.InvoiceSummariesRecordControl invoiceSummariesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "InvoiceSummariesRecordControl") as IDE.UI.Controls.Edit_InvoiceSummaries_Contact.InvoiceSummariesRecordControl);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        protected virtual void OrderSort2_SelectedIndexChanged(object sender, EventArgs args)
        {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(EnergyChargesTable.GetColumnByName(SelVal2));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (EnergyChargesTable.GetColumnByName(SelVal2) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal2 != "--PLEASE_SELECT--" && EnergyChargesTable.GetColumnByName(SelVal2) != null)
                  {
                    if (words2[words2.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(EnergyChargesTable.GetColumnByName(SelVal2),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words2[words2.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(EnergyChargesTable.GetColumnByName(SelVal2),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Functions"
        ...
        public virtual EnergyChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyChargesTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_InvoiceSummaries_Contact.EnergyChargesTableControlRow")));
...
// Base class for the NetworkChargesTableControlRow control on the Edit_InvoiceSummaries_Contact page.
...
// Base class for the NetworkChargesTableControl control on the Edit_InvoiceSummaries_Contact page.
...
#region "Helper Functions"
        ...
        public virtual NetworkChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (NetworkChargesTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_InvoiceSummaries_Contact.NetworkChargesTableControlRow")));
...
// Base class for the OtherChargesTableControlRow control on the Edit_InvoiceSummaries_Contact page.
...
// Base class for the OtherChargesTableControl control on the Edit_InvoiceSummaries_Contact page.
...
#region "Helper Functions"
        ...
        public virtual OtherChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (OtherChargesTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_InvoiceSummaries_Contact.OtherChargesTableControlRow")));
...
// Base class for the InvoiceSummariesRecordControl control on the Edit_InvoiceSummaries_Contact page.
...
public class BaseInvoiceSummariesRecordControl : IDE.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in InvoiceSummariesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-InvoiceSummaries-Contact"] = recId;
