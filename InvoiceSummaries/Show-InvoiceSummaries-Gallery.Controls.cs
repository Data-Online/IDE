...
// Show_InvoiceSummaries_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_InvoiceSummaries_Gallery
{
...
// Base class for the InvoiceSummariesTableControlRow control on the Show_InvoiceSummaries_Gallery page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("InvoiceSummariesTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + InvoiceSummariesTableControlRow.ModifyRedirectUrl(\"../InvoiceSummaries/Show-InvoiceSummaries.aspx?InvoiceSummaries={PK}\", \"\", True) + \"\\\">\" + SiteName + \"</a>\", InvoiceSummariesTableControlRow.ModifyRedirectUrl(\"../InvoiceSummaries/Show-InvoiceSummaries.aspx?InvoiceSummaries={PK}\", \"\", True))");
...
// Base class for the InvoiceSummariesTableControl control on the Show_InvoiceSummaries_Gallery page.
...
public class BaseInvoiceSummariesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return InvoiceSummariesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual InvoiceSummariesRecord[] CopyArray(int index, InvoiceSummariesRecord[,] recs, int columns)
      {
        InvoiceSummariesRecord[] recsCopy = new InvoiceSummariesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            InvoiceSummariesRecord[,] recs = new InvoiceSummariesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            InvoiceSummariesRecord[] HColDataSource = new InvoiceSummariesRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "InvoiceSummariesTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              InvoiceSummariesRecord[] VColDataSource = new InvoiceSummariesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("InvoiceSummariesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              InvoiceSummariesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                InvoiceSummariesTableControlRow recControl = (InvoiceSummariesTableControlRow)innerRepItem.FindControl("InvoiceSummariesTableControlRow");
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              InvoiceSummariesTableControlRow[] recControls = this.GetRecordControls();
                foreach (InvoiceSummariesTableControlRow recControl in recControls) 
		{
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-InvoiceSummaries-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "InvoiceSummaries";
                // If Show-InvoiceSummaries-Gallery.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${SiteName}", record.Format(InvoiceSummariesTable.SiteName), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-InvoiceSummaries-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "InvoiceSummaries";
                // If Show-InvoiceSummaries-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual InvoiceSummariesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InvoiceSummariesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_InvoiceSummaries_Gallery.InvoiceSummariesTableControlRow")));
