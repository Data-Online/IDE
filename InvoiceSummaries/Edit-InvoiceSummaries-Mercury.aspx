...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-InvoiceSummaries-Mercury.aspx.cs" Culture="en-GB" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IDE.UI.Edit_InvoiceSummaries_Mercury" %>
...
<%@ Register Tagprefix="IDE" Namespace="IDE.UI.Controls.Edit_InvoiceSummaries_Mercury" Assembly="IDE" %>
...
</td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="SiteIdLabel" Text="Site" visible="True">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="SiteId" redirecturl="" visible="True"></BaseClasses:QuickSelector> </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="ConnectionNumberLabel" Text="ICP Number">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="EnergyPointId" redirecturl=""></BaseClasses:QuickSelector></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceDueDateLabel" Text="Invoice Due Date">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceDueDateTextBoxMaxLengthValidator" ControlToValidate="InvoiceDueDate" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Due Date&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="InvoiceNumberLabel" Text="Invoice Number">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="InvoiceNumberTextBoxMaxLengthValidator" ControlToValidate="InvoiceNumber" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="KWhTotalLabel" Text="Metered kWh total (charges only)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" rowspan="12" colspan="2">
                              <asp:CheckBox runat="server" id="SelectRow2" onclick="moveToThisTableRow(this);" visible="False">	</asp:CheckBox>                              
                            </td><td class="tableRowButtonsCellVertical" rowspan="12">
...
</td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td><td class="tableCellLabel" style="text-align:center;font-weight:bold;color:#0080FF;"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total4" runat="server" text="Page Total"></asp:label></td><td class="tableCellLabel" style="text-align:left;font-weight:bold;"><asp:literal id="Literal8" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel" colspan="4" style="text-align:left;font-weight:bold;color:#00FF40;"></td><td class="tableCellLabel" style="text-align:left;font-weight:bold;color:#00FF40;"></td></tr><tr><td class="tableRowDivider" colspan="7"></td><td class="tableRowDivider"></td></tr></IDE:EnergyChargesTableControlRow>
</ITEMTEMPLATE>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="FixedChargeTextBoxMaxLengthValidator" ControlToValidate="FixedCharge" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, &quot;Fixed Charge&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CapacityChargeLabel" Text="Capacity Charge">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="VariableBDLabel" Text="Variable Anytime">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="VariableBDTextBoxMaxLengthValidator" ControlToValidate="VariableBD" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Variable Charge Business/Weekday\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellLabel" style="font-weight:bold"><asp:Literal runat="server" id="DemandChargeLabel" Text="Demand Charge">	</asp:Literal></td><td class="tableCellValue" style="font-weight:bold"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total" runat="server" text="Total"></asp:label></td><td class="tableCellValue" style="font-weight:bold"><asp:literal id="LineChargeSum" runat="server" text="Text for literal goes here"></asp:literal></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="7"></td></tr></IDE:NetworkChargesTableControlRow>
</ITEMTEMPLATE>
...
<tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel"><asp:Literal runat="server" id="AdminChargeLabel" Text="Meter Fees">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="AdminChargeTextBoxMaxLengthValidator" ControlToValidate="AdminCharge" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IDE&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Other Charges Total\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
...
</td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:left;"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:left;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:left;"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;"></td><td class="tableRowButtonsCellVertical"></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:left;"><asp:literal id="Literal4" runat="server" text="Rate"></asp:literal></td><td class="tableCellLabel" style="color:#0080FF;text-align:center;"></td><td class="tableCellLabel" style="color:#0080FF;text-align:left;"></td></tr><tr><td class="tableCellSelectCheckbox" scope="row" style="font-size: 5px;" rowspan="5" colspan="3">
                        ...
                        </td><td class="tableCellLabel"><asp:Literal runat="server" id="EALevyRLabel1" Text="EvaluateFormula(&quot;= \&quot;Electricity Authority Rate / EA Levy Rate\&quot;&quot;, true)">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel" style="font-weight:bold"><asp:label id="Total3" runat="server" text="Total"></asp:label></td><td class="tableCellValue"><asp:literal id="Literal7" runat="server" text="Text for literal goes here"></asp:literal></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></IDE:OtherChargesTableControlRow>
</ITEMTEMPLATE>
