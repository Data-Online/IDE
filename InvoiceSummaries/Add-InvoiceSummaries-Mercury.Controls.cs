...
// Add_InvoiceSummaries_Mercury.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Add_InvoiceSummaries_Mercury
{
    ...
    this.Init += new EventHandler(MultipleDropdown_MyInit);
		...
		public override void SetSupplierId()
        {
            ...
            else
            {
                ...
                selectedValue = "5"; // EvaluateFormula("URL(\"SupplierId\")");
...
// Base class for the EnergyChargesRecordControl control on the Add_InvoiceSummaries_Mercury page.
...
// Base class for the InvoiceSummariesRecordControl control on the Add_InvoiceSummaries_Mercury page.
...
public class BaseInvoiceSummariesRecordControl : IDE.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in InvoiceSummariesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-InvoiceSummaries-Mercury"] = recId;
...
// Base class for the NetworkChargesRecordControl control on the Add_InvoiceSummaries_Mercury page.
...
// Base class for the OtherChargesRecordControl control on the Add_InvoiceSummaries_Mercury page.
