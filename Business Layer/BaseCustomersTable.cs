...
/// Provides access to the schema information and record data of a database table or view named DatabaseCimscoPortal%dbo.Customers.
/// </summary>
/// <remarks>
...
public class BaseCustomersTable : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.CustomersTable");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.CustomersRecord");
        ...
        AddressIdColumn.CodeName = "AddressId";
        Contact_ContactIdColumn.CodeName = "Contact_ContactId";
...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.CustomerId column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn CustomerId
    {
        get
        {
            return CustomersTable.Instance.CustomerIdColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.CustomerName column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn CustomerName
    {
        get
        {
            return CustomersTable.Instance.CustomerNameColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.AddressId column object.
    /// </summary>
    public BaseClasses.Data.NumberColumn AddressIdColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Customers_.AddressId column object.
    /// </summary>
    public static BaseClasses.Data.NumberColumn AddressId
    {
        get
        {
            return CustomersTable.Instance.AddressIdColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.Contact_ContactId column object.
    /// </summary>
    public BaseClasses.Data.NumberColumn Contact_ContactIdColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Customers_.Contact_ContactId column object.
    /// </summary>
    public static BaseClasses.Data.NumberColumn Contact_ContactId
    {
        get
        {
            return CustomersTable.Instance.Contact_ContactIdColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.Address1 column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn Address1
    {
        get
        {
            return CustomersTable.Instance.Address1Column;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.Address2 column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn Address2
    {
        get
        {
            return CustomersTable.Instance.Address2Column;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.Address3 column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn Address3
    {
        get
        {
            return CustomersTable.Instance.Address3Column;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.PostCode column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn PostCode
    {
        get
        {
            return CustomersTable.Instance.PostCodeColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Customers_.CityId column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn CityId
    {
        get
        {
            return CustomersTable.Instance.CityIdColumn;
        }
    }
...
#region "Shared helper methods"
    ...
    public static CustomersRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (CustomersRecord[])recList.ToArray(Type.GetType("IDE.Business.CustomersRecord"));
    }   
    ...
    {
        return (int)CustomersTable.Instance.GetCountResponseForPost(CustomersTable.Instance.TableDefinition, selectCols, join, finalFilter);
    }
			...
			KeylessVirtualTable table = null, Boolean isGetColumnValues = false)
    {
        ...
        if (table == null)
        {
            recList = CustomersTable.Instance.GetRecordListResponseForPost(CustomersTable.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection,
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        rec.SetString(AddressIdValue, AddressIdColumn);
        rec.SetString(Contact_ContactIdValue, Contact_ContactIdColumn);
