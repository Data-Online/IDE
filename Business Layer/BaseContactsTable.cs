...
/// Provides access to the schema information and record data of a database table or view named DatabaseCimscoPortal%dbo.Contacts.
/// </summary>
/// <remarks>
...
public class BaseContactsTable : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.ContactsTable");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.ContactsRecord");
        ...
        SalutationColumn.CodeName = "Salutation";
        PreferredNameColumn.CodeName = "PreferredName";
...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Contacts_.Salutation column object.
    /// </summary>
    public BaseClasses.Data.StringColumn SalutationColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Contacts_.Salutation column object.
    /// </summary>
    public static BaseClasses.Data.StringColumn Salutation
    {
        get
        {
            return ContactsTable.Instance.SalutationColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Contacts_.PreferredName column object.
    /// </summary>
    public BaseClasses.Data.StringColumn PreferredNameColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Contacts_.PreferredName column object.
    /// </summary>
    public static BaseClasses.Data.StringColumn PreferredName
    {
        get
        {
            return ContactsTable.Instance.PreferredNameColumn;
        }
    }
...
#region "Shared helper methods"
    ...
    public static ContactsRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (ContactsRecord[])recList.ToArray(Type.GetType("IDE.Business.ContactsRecord"));
    }   
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        rec.SetString(SalutationValue, SalutationColumn);
        rec.SetString(PreferredNameValue, PreferredNameColumn);
