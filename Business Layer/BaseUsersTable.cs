...
/// Provides access to the schema information and record data of a database table or view named DatabaseCimscoPortal%dbo.Users.
/// </summary>
/// <remarks>
...
#region "IUserIdentityTable Members"
	...
	{
		return (BaseClasses.IUserRoleTable)null;
	}
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.UsersTable");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("IDE.Business", "IDE.Business.UsersRecord");
...
#region "Shared helper methods"
    ...
    public static UsersRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (UsersRecord[])recList.ToArray(Type.GetType("IDE.Business.UsersRecord"));
    }   
