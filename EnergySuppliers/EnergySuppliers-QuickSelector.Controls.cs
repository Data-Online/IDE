...
// EnergySuppliers_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.EnergySuppliers_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the EnergySuppliers_QuickSelector page.
...
public class BaseSelectorTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseCimscoPortal%dbo.EnergySuppliers record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = EnergySuppliersTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new EnergySuppliersRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          EnergySuppliersTable.DeleteRecord(pkValue);
        ...
        public EnergySuppliersRecord DataSource {
            get {
                return (EnergySuppliersRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    EnergySuppliersRecord rec = null;
        ...
        public virtual EnergySuppliersRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return EnergySuppliersTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the EnergySuppliers_QuickSelector page.
...
public class BaseSelectorTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IDE.Business.EnergySuppliersRecord);
                      this.DataSource = (EnergySuppliersRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(IDE.Business.EnergySuppliersRecord);
                    this.DataSource = (EnergySuppliersRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual EnergySuppliersRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(EnergySuppliersTable.Column1, true);          
            // selCols.Add(EnergySuppliersTable.Column2, true);          
            // selCols.Add(EnergySuppliersTable.Column3, true);          
                  ...
                  
            {
                ...
                return EnergySuppliersTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                EnergySuppliersTable databaseTable = new EnergySuppliersTable();
                ...
                return (recList.ToArray(typeof(EnergySuppliersRecord)) as EnergySuppliersRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return EnergySuppliersTable.GetRecordCount(join, where);
            else
            {
                EnergySuppliersTable databaseTable = new EnergySuppliersTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = EnergySuppliersTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, EnergySuppliersTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = EnergySuppliersTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            EnergySuppliersTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = EnergySuppliersTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.EnergySuppliersRecord[] recordList  = EnergySuppliersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (EnergySuppliersRecord rec in recordList ){
      ...
      EnergySuppliersRecord rec = new EnergySuppliersRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new EnergySuppliersRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IDE.Business.EnergySuppliersRecord);
                this.DataSource = (EnergySuppliersRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = EnergySuppliersTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  EnergySuppliersRecord[] DataSource {
            ...
            get {
                return (EnergySuppliersRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.EnergySuppliers_QuickSelector.SelectorTableControlRow")));
