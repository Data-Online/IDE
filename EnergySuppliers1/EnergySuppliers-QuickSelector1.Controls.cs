...
// EnergySuppliers_QuickSelector1.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.EnergySuppliers_QuickSelector1
{
...
// Base class for the SelectorTableControlRow control on the EnergySuppliers_QuickSelector1 page.
// Do not modify this class. Instead override any method in SelectorTableControlRow.
public class BaseSelectorTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseCimscoNZ%dbo.EnergySuppliers record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = EnergySuppliers1Table.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new EnergySuppliers1Record();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          EnergySuppliers1Table.DeleteRecord(pkValue);
        ...
        public EnergySuppliers1Record DataSource {
            get {
                return (EnergySuppliers1Record)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    EnergySuppliers1Record rec = null;
        ...
        public virtual EnergySuppliers1Record GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return EnergySuppliers1Table.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the EnergySuppliers_QuickSelector1 page.
// Do not modify this class. Instead override any method in SelectorTableControl.
public class BaseSelectorTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IDE.Business.EnergySuppliers1Record);
                      this.DataSource = (EnergySuppliers1Record[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(IDE.Business.EnergySuppliers1Record);
                    this.DataSource = (EnergySuppliers1Record[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual EnergySuppliers1Record[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(EnergySuppliers1Table.Column1, true);          
            // selCols.Add(EnergySuppliers1Table.Column2, true);          
            // selCols.Add(EnergySuppliers1Table.Column3, true);          
                  ...
                  
            {
                ...
                return EnergySuppliers1Table.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                EnergySuppliers1Table databaseTable = new EnergySuppliers1Table();
                ...
                return (recList.ToArray(typeof(EnergySuppliers1Record)) as EnergySuppliers1Record[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return EnergySuppliers1Table.GetRecordCount(join, where);
            else
            {
                EnergySuppliers1Table databaseTable = new EnergySuppliers1Table();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = EnergySuppliers1Table.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, EnergySuppliers1Table.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = EnergySuppliers1Table.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            EnergySuppliers1Table.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = EnergySuppliers1Table.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.EnergySuppliers1Record[] recordList  = EnergySuppliers1Table.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (EnergySuppliers1Record rec in recordList ){
      ...
      EnergySuppliers1Record rec = new EnergySuppliers1Record();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new EnergySuppliers1Record());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IDE.Business.EnergySuppliers1Record);
                this.DataSource = (EnergySuppliers1Record[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = EnergySuppliers1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  EnergySuppliers1Record[] DataSource {
            ...
            get {
                return (EnergySuppliers1Record[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public IDE.UI.IThemeButton AddButton {
            get {
                return (IDE.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AddButton");
            }
        }
        
        public IDE.UI.IThemeButton ClearButton {
            get {
                return (IDE.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ClearButton");
            }
        }
        
        public IDE.UI.IThemeButton CommitButton {
            get {
                return (IDE.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CommitButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.EnergySuppliers_QuickSelector1.SelectorTableControlRow")));
