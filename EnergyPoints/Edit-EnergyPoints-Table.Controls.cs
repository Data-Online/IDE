...
// Edit_EnergyPoints_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Edit_EnergyPoints_Table
{
...
// Base class for the EnergyPointsTableControlRow control on the Edit_EnergyPoints_Table page.
...
public class BaseEnergyPointsTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.EnergyPointNumber.TextChanged += EnergyPointNumber_TextChanged;
        ...
        public virtual void SetEnergyPointNumber()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.EnergyPointNumber.ID))
            {
            
                this.EnergyPointNumber.Text = this.PreviousUIData[this.EnergyPointNumber.ID].ToString();
              
                return;
            }
            
                    
            // Set the EnergyPointNumber TextBox on the webpage with value from the
            ...
            // this.EnergyPointNumber is the ASP:TextBox on the webpage.
        ...
        public virtual void GetEnergyPointNumber()
        {
            ...
            // Retrieve the value entered by the user on the EnergyPointNumber ASP:TextBox, and
            // save it into the EnergyPointNumber field in DataSource DatabaseCimscoPortal%dbo.EnergyPoints record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.EnergyPointNumber.Text, EnergyPointsTable.EnergyPointNumber);							
      ...
      // To customize, override this method in EnergyPointsTableControlRow.
        ...
        EnergyPointsTableControl tc= ((EnergyPointsTableControl)MiscUtils.GetParentControlObject(this, "EnergyPointsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((EnergyPointsTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../EnergyPoints/Show-EnergyPoints.aspx?EnergyPoints={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void EnergyPointNumber_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox EnergyPointNumber {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "EnergyPointNumber");
            }
        }
...
// Base class for the EnergyPointsTableControl control on the Edit_EnergyPoints_Table page.
    ...
    // Setup default pagination settings.
      ...
      EnergyPointsRecord rec = new EnergyPointsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("EnergyPointsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (EnergyPointsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        EnergyPointsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual EnergyPointsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyPointsTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_EnergyPoints_Table.EnergyPointsTableControlRow")));
