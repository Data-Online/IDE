...
// This file implements the code-behind class for Edit_EnergyPoints_Table.aspx.
// Edit_EnergyPoints_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_EnergyPoints_Table
        : BaseApplicationPage
// Code-behind class for the Edit_EnergyPoints_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_EnergyPoints_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEnergyPointsTableControl()
        {
            SetEnergyPointsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Edit_EnergyPoints_Table.EnergyPointsTableControl EnergyPointsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EnergyPointsTableControl":
                 SetEnergyPointsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EnergyPointsTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEnergyPointsTableControl_Base()           
        
        {        
            if (EnergyPointsTableControl.Visible)
            {
                EnergyPointsTableControl.LoadData();
                EnergyPointsTableControl.DataBind();
            }
        }
