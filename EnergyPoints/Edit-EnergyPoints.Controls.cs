...
// Edit_EnergyPoints.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Edit_EnergyPoints
{
...
// Base class for the EnergyPointsRecordControl control on the Edit_EnergyPoints page.
...
public class BaseEnergyPointsRecordControl : IDE.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in EnergyPointsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-EnergyPoints"] = recId;
