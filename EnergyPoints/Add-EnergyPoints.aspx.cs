...
// This file implements the code-behind class for Add_EnergyPoints.aspx.
// Add_EnergyPoints.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_EnergyPoints
        : BaseApplicationPage
// Code-behind class for the Add_EnergyPoints page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_EnergyPoints()
        {
            this.Initialize();
...
//        public void SetEnergyPointsTabContainer()
//        {
//            SetEnergyPointsTabContainer_Base(); 
//        }
        
        public void SetEnergyPointsRecordControl()
        {
            SetEnergyPointsRecordControl_Base(); 
        }
        
//        public void SetInvoiceSummariesTableControl1()
//        {
//            SetInvoiceSummariesTableControl1_Base(); 
//        }
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Add_EnergyPoints.EnergyPointsRecordControl EnergyPointsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Energy Points");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EnergyPointsRecordControl":
                 SetEnergyPointsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EnergyPointsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEnergyPointsRecordControl_Base()           
        
        {        
            if (EnergyPointsRecordControl.Visible)
            {
                EnergyPointsRecordControl.LoadData();
                EnergyPointsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.EnergyPointsRecordControl != null && this.EnergyPointsRecordControl.DataSource != null)
                  {
                        id = this.EnergyPointsRecordControl.DataSource.GetValue(this.EnergyPointsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.EnergyPointsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.EnergyPointsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.EnergyPointsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.EnergyPointsRecordControl.DataSource.GetValue(this.EnergyPointsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
