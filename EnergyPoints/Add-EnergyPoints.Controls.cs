...
// Add_EnergyPoints.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Add_EnergyPoints
{
...
// Base class for the EnergyPointsRecordControl control on the Add_EnergyPoints page.
...
public class BaseEnergyPointsRecordControl : IDE.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (EnergyPointsRecord)EnergyPointsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in EnergyPointsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["EnergyPoints"];
            ...
            HttpContext.Current.Session["QueryString in Add-EnergyPoints"] = recId;
