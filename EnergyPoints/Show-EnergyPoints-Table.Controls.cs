...
// Show_EnergyPoints_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_EnergyPoints_Table
{
...
// Base class for the EnergyPointsTableControlRow control on the Show_EnergyPoints_Table page.
...
// Base class for the EnergyPointsTableControl control on the Show_EnergyPoints_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyPoints-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyPoints";
                // If Show-EnergyPoints-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyPoints-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyPoints";
                // If Show-EnergyPoints-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual EnergyPointsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyPointsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_EnergyPoints_Table.EnergyPointsTableControlRow")));
