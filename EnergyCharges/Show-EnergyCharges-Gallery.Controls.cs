...
// Show_EnergyCharges_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_EnergyCharges_Gallery
{
...
// Base class for the EnergyChargesTableControlRow control on the Show_EnergyCharges_Gallery page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("EnergyChargesTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + EnergyChargesTableControlRow.ModifyRedirectUrl(\"../EnergyCharges/Show-EnergyCharges.aspx?EnergyCharges={PK}\", \"\", True) + \"\\\">\" + BD0004 + \"</a>\", EnergyChargesTableControlRow.ModifyRedirectUrl(\"../EnergyCharges/Show-EnergyCharges.aspx?EnergyCharges={PK}\", \"\", True))");
...
// Base class for the EnergyChargesTableControl control on the Show_EnergyCharges_Gallery page.
...
public class BaseEnergyChargesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return EnergyChargesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual EnergyChargesRecord[] CopyArray(int index, EnergyChargesRecord[,] recs, int columns)
      {
        EnergyChargesRecord[] recsCopy = new EnergyChargesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            EnergyChargesRecord[,] recs = new EnergyChargesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            EnergyChargesRecord[] HColDataSource = new EnergyChargesRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "EnergyChargesTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              EnergyChargesRecord[] VColDataSource = new EnergyChargesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("EnergyChargesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              EnergyChargesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                EnergyChargesTableControlRow recControl = (EnergyChargesTableControlRow)innerRepItem.FindControl("EnergyChargesTableControlRow");
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              EnergyChargesTableControlRow[] recControls = this.GetRecordControls();
                foreach (EnergyChargesTableControlRow recControl in recControls) 
		{
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyCharges-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Show-EnergyCharges-Gallery.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${BD0004}", record.Format(EnergyChargesTable.BD0004), ReportEnum.Align.Right);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyCharges-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Show-EnergyCharges-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public IDE.UI.IInfinitePagination Pagination {
            get {
                return (IDE.UI.IInfinitePagination)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Pagination");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual EnergyChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyChargesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_EnergyCharges_Gallery.EnergyChargesTableControlRow")));
