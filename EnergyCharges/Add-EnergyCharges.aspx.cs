...
// This file implements the code-behind class for Add_EnergyCharges.aspx.
// Add_EnergyCharges.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_EnergyCharges
        : BaseApplicationPage
// Code-behind class for the Add_EnergyCharges page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_EnergyCharges()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Add_EnergyCharges.EnergyChargesRecordControl EnergyChargesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Energy Charges");
      ...
      public void SaveData_Base()
      {
        ...
        this.EnergyChargesRecordControl.SaveData();
        ...
        SetEnergyChargesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "EnergyChargesMenuItem";
                    }
                }
