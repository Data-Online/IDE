...
// Group_By_EnergyCharges_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Group_By_EnergyCharges_Table
{
...
// Base class for the EnergyChargesTableControlRow control on the Group_By_EnergyCharges_Table page.
...
// Base class for the EnergyChargesTableControl control on the Group_By_EnergyCharges_Table page.
...
public class BaseEnergyChargesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      EnergyChargesRecord rec = new EnergyChargesRecord();
                        ...
                        if (recControl.EnergyChargeId.Text != "") {
                            rec.Parse(recControl.EnergyChargeId.Text, EnergyChargesTable.EnergyChargeId);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             EnergyChargesTable.EnergyChargeId,
             ...
             null};
              ...
              DataForExport data = new DataForExport(EnergyChargesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(EnergyChargesTable.EnergyChargeId, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-EnergyCharges-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Group-By-EnergyCharges-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(EnergyChargesTable.EnergyChargeId.Name, ReportEnum.Align.Left, "${EnergyChargeId}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 if (BaseClasses.Utils.MiscUtils.IsNull(record.EnergyChargeId)){
                                 report.AddData("${EnergyChargeId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = EnergyChargesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyChargesTable.EnergyChargeId);
                                 _DFKA = EnergyChargesTable.GetDFKA(record.EnergyChargeId.ToString(), EnergyChargesTable.EnergyChargeId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  EnergyChargesTable.EnergyChargeId.IsApplyDisplayAs){
                                     report.AddData("${EnergyChargeId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${EnergyChargeId}", record.Format(EnergyChargesTable.EnergyChargeId), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-EnergyCharges-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Group-By-EnergyCharges-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual EnergyChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyChargesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Group_By_EnergyCharges_Table.EnergyChargesTableControlRow")));
