...
// Show_EnergyCharges_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_EnergyCharges_Table
{
...
// Base class for the EnergyChargesTableControlRow control on the Show_EnergyCharges_Table page.
...
public class BaseEnergyChargesTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        SetInvoiceSummariesRecordControl();
        ...
        public virtual void SetEnergyChargesTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "EnergyChargesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "EnergyChargesTabContainer").Visible = false;
         
  
        }      
      
        public virtual void SetInvoiceSummariesRecordControl()           
        
        {        
            if (InvoiceSummariesRecordControl.Visible)
            {
                InvoiceSummariesRecordControl.LoadData();
                InvoiceSummariesRecordControl.DataBind();
            }
        }
        ...
        public virtual void SaveData()
        {
          ...
          InvoiceSummariesRecordControl recInvoiceSummariesRecordControl = (InvoiceSummariesRecordControl)(MiscUtils.FindControlRecursively(this, "InvoiceSummariesRecordControl"));
        recInvoiceSummariesRecordControl.SaveData();
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                EnergyChargesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "EnergyChargesTableControl") as EnergyChargesTableControl);

          EnergyChargesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (EnergyChargesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "EnergyChargesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer EnergyChargesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "EnergyChargesTabContainer");
            }
        }
        ...
        public InvoiceSummariesRecordControl InvoiceSummariesRecordControl {
            get {
                return (InvoiceSummariesRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvoiceSummariesRecordControl");
            }
        }
...
// Base class for the EnergyChargesTableControl control on the Show_EnergyCharges_Table page.
...
public class BaseEnergyChargesTableControl : IDE.UI.BaseApplicationTableControl
{
       ...
       public BaseEnergyChargesTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.BD0004FromFilter)) 				
                    initialVal = this.GetFromSession(this.BD0004FromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"BD0004From\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.BD0004FromFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.BD0004ToFilter)) 				
                    initialVal = this.GetFromSession(this.BD0004ToFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"BD0004To\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.BD0004ToFilter.Text = initialVal;
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        EnergyChargesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "EnergyChargesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.BD0004FromFilter.Text = "";
            
            this.BD0004ToFilter.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.BD0004FromFilter)) {
                        
                wc.iAND(EnergyChargesTable.BD0004, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(this.BD0004FromFilter, this.GetFromSession(this.BD0004FromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.BD0004ToFilter)) {
                        
                wc.iAND(EnergyChargesTable.BD0004, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, MiscUtils.GetSelectedValue(this.BD0004ToFilter, this.GetFromSession(this.BD0004ToFilter)), false, false);
      ...
      String BD0004FromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "BD0004FromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(BD0004FromFilterSelectedValue)) {

              
                wc.iAND(EnergyChargesTable.BD0004, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, BD0004FromFilterSelectedValue, false, false);
                      
      }
                      
      String BD0004ToFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "BD0004ToFilter_Ajax"];
            if (MiscUtils.IsValueSelected(BD0004ToFilterSelectedValue)) {

              
                wc.iAND(EnergyChargesTable.BD0004, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, BD0004ToFilterSelectedValue, false, false);
      ...
      EnergyChargesRecord rec = new EnergyChargesRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("BD1620R {Txt:Ascending}"), "BD1620R Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("BD1620R {Txt:Descending}"), "BD1620R Desc"));
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.BD0004FromFilter, this.BD0004FromFilter.Text);
                  
            this.SaveToSession(this.BD0004ToFilter, this.BD0004ToFilter.Text);
      ...
      this.SaveToSession("BD0004FromFilter_Ajax", this.BD0004FromFilter.Text);
              
      this.SaveToSession("BD0004ToFilter_Ajax", this.BD0004ToFilter.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.BD0004FromFilter);
            this.RemoveFromSession(this.BD0004ToFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=EnergyCharges" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../EnergyCharges/Add-EnergyCharges.aspx?TabVisible=False&SaveAndNewVisible=False";
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(BD0004FromFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(BD0004ToFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyCharges-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Show-EnergyCharges-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyCharges-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyCharges";
                // If Show-EnergyCharges-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox BD0004FromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BD0004FromFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox BD0004ToFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BD0004ToFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual EnergyChargesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (EnergyChargesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_EnergyCharges_Table.EnergyChargesTableControlRow")));
...
// Base class for the InvoiceSummariesRecordControl control on the Show_EnergyCharges_Table page.
...
public class BaseInvoiceSummariesRecordControl : IDE.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          EnergyChargesTableControlRow parentCtrl;
      
            parentCtrl = (EnergyChargesTableControlRow)MiscUtils.GetParentControlObject(this, "EnergyChargesTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue energyChargesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = energyChargesRecordObj;
          energyChargesRecordObj = tmp;
        EnergyChargesTableControlRow energyChargesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "EnergyChargesTableControlRow") as EnergyChargesTableControlRow);
          
              if (energyChargesTableControlObjRow != null && energyChargesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(InvoiceSummariesTable.InvoiceSummaryId, BaseFilter.ComparisonOperator.EqualsTo, energyChargesTableControlObjRow.GetRecord().EnergyChargeId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["InvoiceSummariesRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInEnergyChargesTableControl = HttpContext.Current.Session["InvoiceSummariesRecordControlWhereClause"] as string;
      
      if (selectedRecordInEnergyChargesTableControl != null && KeyValue.IsXmlKey(selectedRecordInEnergyChargesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInEnergyChargesTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(InvoiceSummariesTable.InvoiceSummaryId))
      {
      wc.iAND(InvoiceSummariesTable.InvoiceSummaryId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(InvoiceSummariesTable.InvoiceSummaryId).ToString());
      }
