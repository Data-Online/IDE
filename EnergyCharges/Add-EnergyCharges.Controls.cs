...
// Add_EnergyCharges.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Add_EnergyCharges
{
...
// Base class for the EnergyChargesRecordControl control on the Add_EnergyCharges page.
...
public class BaseEnergyChargesRecordControl : IDE.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetEnergyChargeId()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"EnergyChargeId\")");
      ...
      // To customize, override this method in EnergyChargesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["EnergyCharges"];
            ...
            HttpContext.Current.Session["QueryString in Add-EnergyCharges"] = recId;
