...
// AspNetUsers_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.AspNetUsers_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the AspNetUsers_QuickSelector page.
...
public class BaseSelectorTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = AspNetUsersTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the AspNetUsers_QuickSelector page.
...
public class BaseSelectorTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IDE.Business.AspNetUsersRecord);
                      this.DataSource = (AspNetUsersRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(IDE.Business.AspNetUsersRecord);
                    this.DataSource = (AspNetUsersRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual AspNetUsersRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(AspNetUsersTable.Column1, true);          
            // selCols.Add(AspNetUsersTable.Column2, true);          
            // selCols.Add(AspNetUsersTable.Column3, true);          
                  ...
                  
            {
                ...
                return AspNetUsersTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                AspNetUsersTable databaseTable = new AspNetUsersTable();
                ...
                return (recList.ToArray(typeof(AspNetUsersRecord)) as AspNetUsersRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return AspNetUsersTable.GetRecordCount(join, where);
            else
            {
                AspNetUsersTable databaseTable = new AspNetUsersTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = AspNetUsersTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, AspNetUsersTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = AspNetUsersTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = AspNetUsersTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.AspNetUsersRecord[] recordList  = AspNetUsersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (AspNetUsersRecord rec in recordList ){
      ...
      AspNetUsersRecord rec = new AspNetUsersRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new AspNetUsersRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IDE.Business.AspNetUsersRecord);
                this.DataSource = (AspNetUsersRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = AspNetUsersTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  AspNetUsersRecord[] DataSource {
            ...
            get {
                return (AspNetUsersRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.AspNetUsers_QuickSelector.SelectorTableControlRow")));
