...
namespace IDE.UI.Controls.Groups_QuickSelector
{
...
public class BaseSelectorTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseCimscoPortal%dbo.Groups record.
    ...
    // Setup default pagination settings.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IDE.Business.GroupsRecord);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.GroupsRecord[] recordList  = GroupsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Groups_QuickSelector.SelectorTableControlRow")));
