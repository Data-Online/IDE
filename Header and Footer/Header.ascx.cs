...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "IDE");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "IDE");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "IDE");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "IDE");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "IDE");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "IDE");
