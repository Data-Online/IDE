<%@ Page Language="c#" AutoEventWireup="true" EnableEventValidation="false" Codebehind="Show_Error.aspx.cs" Inherits="IDE.UI.Show_Error" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse"
                                            ...
                                            <tr>
                                                ...
                                                <td class="configureErrorPagesText">
                                                    <br />
                                                    <asp:Literal ID="ShowErrorLine1" runat="server" Text='<%# GetResourceValue("Txt:ShowErrorLine1", "IDE") %>' /><br />
                                                    <br />
