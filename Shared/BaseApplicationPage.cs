...
#region "Section 1: Place your customizations here."
    ...
    public class BaseApplicationPage : BaseApplicationPageGEN
    {
        ...
        private static bool BlobExistsOnCloud(CloudBlobClient client, string containerName, string key)
        {
        ...
        public bool UploadToBlob(string key, string container, System.Web.UI.HtmlControls.HtmlInputFile inputFile = null)
        {
            ...
            if (!(String.IsNullOrEmpty(_key) | String.IsNullOrEmpty(_container)))
            {
                try
                {
                    ...
                    CloudBlobContainer blobContainer = bc.GetContainerReference(_container);

                    blobContainer.CreateIfNotExists();

                    CloudBlockBlob b = blobContainer.GetBlockBlobReference(_key);
                    ...
                    // Verify that the sile has been uploaded
                    if (BlobExistsOnCloud(bc, _container, _key))
                    {
                        return true;
                    }
                }
        ...
        public void SetInvoiceAsFiled(int InvoiceSummaryId)
        {
            InvoiceSummariesRecord rec = InvoiceSummariesTable.GetRecord(InvoiceSummaryId.ToString(), true);
            rec.Save();
        }

        public string CallCustomStoredProcedure(string storeProcedureName, int primaryId, bool onfile) 
		{
            // Call named stored procedure

            // This part defines parameters appropriate for specific stored procedure.
            BaseClasses.Data.StoredProcedureParameter firstParameter = new BaseClasses.Data.StoredProcedureParameter("@pk_InvoiceID", primaryId, System.Data.SqlDbType.Int, System.Data.ParameterDirection.Input);
            BaseClasses.Data.StoredProcedureParameter secondParameter = new BaseClasses.Data.StoredProcedureParameter("@invOnFile", onfile, System.Data.SqlDbType.Bit, System.Data.ParameterDirection.Input);
            BaseClasses.Data.StoredProcedureParameter[] parameterList = new BaseClasses.Data.StoredProcedureParameter[2]; 
            parameterList[0] = firstParameter;
            parameterList[1] = secondParameter;

            BaseClasses.Data.StoredProcedure myStoredProcedure = null;
            myStoredProcedure = new BaseClasses.Data.StoredProcedure("DatabaseCimscoPortal", storeProcedureName, parameterList);    
            String message = "";
			if (myStoredProcedure.RunQuery()) 
			{
                ...
                {
                    message += string.Format("{0}<br/>",myRow[0].ToString());
                }
