...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ImportData.aspx.cs" Inherits="IDE.UI.ImportData" %>
<%@ Register Tagprefix="Selectors" Namespace="IDE" %>
				...
				<table class="importWizarddv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="importWizarddBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><IDE:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;IDE&quot;) %>">
		</IDE:ThemeButton></td>
									<td><IDE:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;IDE&quot;) %>">
		</IDE:ThemeButton></td>
								</tr>
							</table>
						</td>
