...
/// <see cref="EnergySuppliersTable">IDE.EnergySuppliersTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="EnergySuppliersTable"></seealso>
public class EnergySuppliersDefinition
{
#region "Definition (XML) for EnergySuppliersDefinition table"
	//Next 73 lines contain Table Definition (XML) for table "EnergySuppliersDefinition"
	...
	/// <see cref="EnergySuppliersTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<FolderName>EnergySuppliers</FolderName>");
         tbf.Append(  @"<MenuName>Energy Suppliers</MenuName>");
         tbf.Append(  @"<QSPath>../EnergySuppliers/EnergySuppliers-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>EnergySuppliers</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pIDEEnergySuppliers</TableStoredProcPrefix>");
