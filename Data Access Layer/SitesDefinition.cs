...
/// <see cref="SitesTable">IDE.SitesTable</see> class
...
#region "Definition (XML) for SitesDefinition table"
	//Next 441 lines contain Table Definition (XML) for table "SitesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_dbo.Sites_dbo.Groups_GroupId</columnFKName>");
         tbf.Append(        @"<columnFKTable>IDE.Business.GroupsTable, IDE.Business</columnFKTable>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_dbo.Sites_dbo.Customers_CustomerId</columnFKName>");
         tbf.Append(        @"<columnFKTable>IDE.Business.CustomersTable, IDE.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_dbo.Sites_dbo.Divisions_GroupDivisionId</columnFKName>");
         tbf.Append(        @"<columnFKTable>IDE.Business.DivisionsTable, IDE.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_dbo.Sites_dbo.IndustryClassifications_IndustryId</columnFKName>");
         tbf.Append(        @"<columnFKTable>IDE.Business.IndustryClassificationsTable, IDE.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         ...
         tbf.Append(      @"<columnName>FiledInvoiceCount</columnName>");
         tbf.Append(      @"<columnUIName>Filed Invoice Count</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(  @"<TableCodeName>Sites</TableCodeName>");
         tbf.Append(  @"<FolderName>Sites</FolderName>");
         tbf.Append(  @"<MenuName>Sites</MenuName>");
         tbf.Append(  @"<QSPath>../Sites/Sites-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIDESites</TableStoredProcPrefix>");
