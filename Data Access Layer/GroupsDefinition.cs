...
/// <see cref="GroupsTable">IDE.GroupsTable</see> class
...
#region "Definition (XML) for GroupsDefinition table"
	//Next 134 lines contain Table Definition (XML) for table "GroupsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_dbo.Groups_dbo.Contacts_Contact_ContactId</columnFKName>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pIDEGroups</TableStoredProcPrefix>");
