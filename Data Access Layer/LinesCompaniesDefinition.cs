...
/// <see cref="LinesCompaniesTable">IDE.LinesCompaniesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="LinesCompaniesTable"></seealso>
public class LinesCompaniesDefinition
{
#region "Definition (XML) for LinesCompaniesDefinition table"
	//Next 333 lines contain Table Definition (XML) for table "LinesCompaniesDefinition"
	...
	/// <see cref="LinesCompaniesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>LinesId</columnName>");
         tbf.Append(      @"<columnUIName>Lines</columnUIName>");
         ...
         tbf.Append(      @"<columnName>LinesCompanyName</columnName>");
         tbf.Append(      @"<columnUIName>Lines Company Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>LinesCompanyLogo</columnName>");
         tbf.Append(      @"<columnUIName>Lines Company Logo</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>50</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>LinesCompanies</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>LinesCompanies_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>LinesCompanies</FolderName>");
         tbf.Append(  @"<MenuName>Lines Companies</MenuName>");
         tbf.Append(  @"<QSPath>../LinesCompanies/LinesCompanies-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>LinesCompanies</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pIDELinesCompanies</TableStoredProcPrefix>");
