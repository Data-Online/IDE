...
/// <see cref="ContactsTable">IDE.ContactsTable</see> class
...
#region "Definition (XML) for ContactsDefinition table"
	//Next 229 lines contain Table Definition (XML) for table "ContactsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>Salutation</columnName>");
         tbf.Append(      @"<columnUIName>Salutation</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>PreferredName</columnName>");
         tbf.Append(      @"<columnUIName>Preferred Name</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>20</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pIDEContacts</TableStoredProcPrefix>");
