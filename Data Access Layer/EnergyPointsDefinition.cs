...
/// <see cref="EnergyPointsTable">IDE.EnergyPointsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="EnergyPointsTable"></seealso>
public class EnergyPointsDefinition
{
#region "Definition (XML) for EnergyPointsDefinition table"
	//Next 97 lines contain Table Definition (XML) for table "EnergyPointsDefinition"
	...
	/// <see cref="EnergyPointsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>EnergyPointNumber</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Connection Number&quot;</columnUIName>");
         ...
         tbf.Append(  @"<TableCodeName>EnergyPoints</TableCodeName>");
         tbf.Append(  @"<FolderName>EnergyPoints</FolderName>");
         tbf.Append(  @"<MenuName>Energy Points</MenuName>");
         tbf.Append(  @"<QSPath>../EnergyPoints/EnergyPoints-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pIDEEnergyPoints</TableStoredProcPrefix>");
