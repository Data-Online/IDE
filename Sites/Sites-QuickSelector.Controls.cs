...
// Sites_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Sites_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Sites_QuickSelector page.
...
// Base class for the SelectorTableControl control on the Sites_QuickSelector page.
...
public class BaseSelectorTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
            ...
            {
                BaseColumn col = SitesTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, SitesTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = SitesTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = SitesTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void AddButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Sites/Add-Sites.aspx";
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Sites_QuickSelector.SelectorTableControlRow")));
