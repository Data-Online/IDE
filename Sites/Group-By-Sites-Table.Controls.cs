...
// Group_By_Sites_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Group_By_Sites_Table
{
...
public class SitesTableControlRow : BaseSitesTableControlRow
{
...
public class SitesTableControl : BaseSitesTableControl
{
...
// Base class for the InvoiceSummariesTableControlRow control on the Group_By_Sites_Table page.
...
public class BaseInvoiceSummariesTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        SitesTableControlRow parentCtrl;
      
            parentCtrl = (SitesTableControlRow)MiscUtils.GetParentControlObject(this, "SitesTableControlRow");
      ...
      // To customize, override this method in InvoiceSummariesTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersSitesTableControl = false;
            hasFiltersSitesTableControl = hasFiltersSitesTableControl && false; // suppress warning
...
// Base class for the InvoiceSummariesTableControl control on the Group_By_Sites_Table page.
...
public class BaseInvoiceSummariesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue sitesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = sitesRecordObj;
          sitesRecordObj = tmp;
        SitesTableControlRow sitesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "SitesTableControlRow") as SitesTableControlRow);
          
              if (sitesTableControlObjRow != null && sitesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(InvoiceSummariesTable.SiteId, BaseFilter.ComparisonOperator.EqualsTo, sitesTableControlObjRow.GetRecord().SiteId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInSitesTableControl = HttpContext.Current.Session["InvoiceSummariesTableControlWhereClause"] as string;
      
      if (selectedRecordInSitesTableControl != null && KeyValue.IsXmlKey(selectedRecordInSitesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInSitesTableControl);
...
#region "Helper Functions"
        ...
        public virtual InvoiceSummariesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InvoiceSummariesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Group_By_Sites_Table.InvoiceSummariesTableControlRow")));
...
// Base class for the SitesTableControlRow control on the Group_By_Sites_Table page.
// Do not modify this class. Instead override any method in SitesTableControlRow.
public class BaseSitesTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        public BaseSitesTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        public virtual void SetSitesTabContainer()    
        ...
        public virtual void SetInvoiceSummariesTableControl()           
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((SitesTableControl)MiscUtils.GetParentControlObject(this, "SitesTableControl")).DataChanged = true;
                ((SitesTableControl)MiscUtils.GetParentControlObject(this, "SitesTableControl")).ResetData = true;
            }
            ...
            this.CheckSum = "";
            // For Master-Detail relationships, save data on the Detail table(s)            
          InvoiceSummariesTableControl recInvoiceSummariesTableControl = (InvoiceSummariesTableControl)(MiscUtils.FindControlRecursively(this, "InvoiceSummariesTableControl"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                SitesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "SitesTableControl") as SitesTableControl);

          SitesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (SitesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "SitesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseSitesTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseSitesTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public InvoiceSummariesTableControl InvoiceSummariesTableControl {
            get {
                return (InvoiceSummariesTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvoiceSummariesTableControl");
            }
        }
        ...
        public AjaxControlToolkit.TabContainer SitesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SitesTabContainer");
            }
        }
...
// Base class for the SitesTableControl control on the Group_By_Sites_Table page.
// Do not modify this class. Instead override any method in SitesTableControl.
public class BaseSitesTableControl : IDE.UI.BaseApplicationTableControl
{
         
       public BaseSitesTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustomerIdFilter)) 				
                    initialVal = this.GetFromSession(this.CustomerIdFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CustomerId\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] CustomerIdFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in CustomerIdFilteritemListFromSession)
                    {
                        ...
                        else
                        {
                            ...
                            this.CustomerIdFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.CustomerIdFilter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.CustomerIdFilter.SelectedIndexChanged += CustomerIdFilter_SelectedIndexChanged;                  
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(IDE.Business.SitesRecord);
                      this.DataSource = (SitesRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (SitesTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(IDE.Business.SitesRecord);
                    this.DataSource = (SitesRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual SitesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(SitesTable.Column1, true);          
            // selCols.Add(SitesTable.Column2, true);          
            // selCols.Add(SitesTable.Column3, true);          
                  ...
                  
            {
                ...
                return SitesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                SitesTable databaseTable = new SitesTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(SitesRecord)) as SitesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return SitesTable.GetRecordCount(join, where);
            else
            {
                SitesTable databaseTable = new SitesTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SitesTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            SitesTableControlRow recControl = (SitesTableControlRow)(repItem.FindControl("SitesTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        SitesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "SitesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(SitesTable.CustomerId, this.DataSource);
            this.Page.PregetDfkaRecords(SitesTable.GroupId, this.DataSource);
        }
        ...
        public virtual void SaveData()
        {
            ...
            foreach (SitesTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CustomerIdFilter)) {
                ...
                foreach (ListItem item in this.CustomerIdFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.CustomerIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(SitesTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(this.GroupIdFilter)) {
                ...
                foreach (ListItem item in this.GroupIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(SitesTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(SitesTable.SiteName, true);
      ...
      String CustomerIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustomerIdFilter_Ajax"];
        ...
        if (CustomerIdFilterSelectedValue != null){
                        string[] CustomerIdFilteritemListFromSession = CustomerIdFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in CustomerIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(SitesTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      String GroupIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "GroupIdFilter_Ajax"];
        ...
        if (GroupIdFilterSelectedValue != null){
                        ...
                        foreach (string item in GroupIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(SitesTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.SitesRecord[] recordList  = SitesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (SitesRecord rec in recordList ){
                ...
                resultItem = rec.Format(SitesTable.SiteName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(SitesTable.SiteName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, SitesTable.SiteName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (recControl.Visible && recControl.IsNewRecord) {
      SitesRecord rec = new SitesRecord();
        
                        if (recControl.CustomerId.Text != "") {
                            rec.Parse(recControl.CustomerId.Text, SitesTable.CustomerId);
                  }
                
                        if (recControl.GroupId.Text != "") {
                            rec.Parse(recControl.GroupId.Text, SitesTable.GroupId);
                  }
                
                        if (recControl.SiteName.Text != "") {
                            rec.Parse(recControl.SiteName.Text, SitesTable.SiteName);
                  }
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IDE.Business.SitesRecord);
                this.DataSource = (SitesRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(SitesTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(SitesTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetCustomerIdLabel1()
                  {
        ...
        public virtual void SetCustomerIdFilter()
        {
            
            ArrayList CustomerIdFilterselectedFilterItemList = new ArrayList();
            string CustomerIdFilteritemsString = null;
            if (this.InSession(this.CustomerIdFilter))
                CustomerIdFilteritemsString = this.GetFromSession(this.CustomerIdFilter);
            
            if (CustomerIdFilteritemsString != null)
            {
                string[] CustomerIdFilteritemListFromSession = CustomerIdFilteritemsString.Split(',');
                foreach (string item in CustomerIdFilteritemListFromSession)
                {
                    CustomerIdFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateCustomerIdFilter(MiscUtils.GetSelectedValueList(this.CustomerIdFilter, CustomerIdFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Customers/Customers-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.CustomerIdFilter.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustomerName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustomerId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.CustomerIdFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(CustomerIdFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer {Txt:Ascending}"), "CustomerId Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer {Txt:Descending}"), "CustomerId Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group {Txt:Ascending}"), "GroupId Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group {Txt:Descending}"), "GroupId Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address 3 {Txt:Ascending}"), "Address3 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address 3 {Txt:Descending}"), "Address3 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Productive Floor Space SQ Meters {Txt:Ascending}"), "ProductiveFloorSpaceSqMeters Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Productive Floor Space SQ Meters {Txt:Descending}"), "ProductiveFloorSpaceSqMeters Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Total Floor Space SQ Meters {Txt:Ascending}"), "TotalFloorSpaceSqMeters Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Total Floor Space SQ Meters {Txt:Descending}"), "TotalFloorSpaceSqMeters Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address 1 {Txt:Ascending}"), "Address1 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address 1 {Txt:Descending}"), "Address1 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group Division {Txt:Ascending}"), "GroupDivisionId Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group Division {Txt:Descending}"), "GroupDivisionId Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Filed Invoice Count {Txt:Ascending}"), "FiledInvoiceCount Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Filed Invoice Count {Txt:Descending}"), "FiledInvoiceCount Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Industry {Txt:Ascending}"), "IndustryId Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Industry {Txt:Descending}"), "IndustryId Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Land SQ Meters {Txt:Ascending}"), "LandSqMeters Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Land SQ Meters {Txt:Descending}"), "LandSqMeters Desc"));
        ...
        protected virtual void PopulateCustomerIdFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_CustomerIdFilter();            
            this.CustomerIdFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CustomerIdFilter function.
                ...
                do
                {
                    ...
                    foreach (CustomersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustomerIdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.CustomerIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = SitesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SitesTable.CustomerId);
                                if(_isExpandableNonCompositeForeignKey && SitesTable.CustomerId.IsApplyDisplayAs)
                                     fvalue = SitesTable.GetDFKA(itemValue, SitesTable.CustomerId);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(CustomersTable.CustomerName);
                                ...
                                ListItem dupItem = this.CustomerIdFilter.Items.FindByText(fvalue);
                                ...
                                this.CustomerIdFilter.Items.Add(newItem);
            ...
            this.CustomerIdFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.CustomerIdFilter.Items.Count == 0)
                this.CustomerIdFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "IDE"), "--ANY--"));
                    ...
                    
        {
                    ...
                    foreach (GroupsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.GroupIdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.GroupIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = SitesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SitesTable.GroupId);
                                if(_isExpandableNonCompositeForeignKey && SitesTable.GroupId.IsApplyDisplayAs)
                                     fvalue = SitesTable.GetDFKA(itemValue, SitesTable.GroupId);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
            ...
            if (this.GroupIdFilter.Items.Count == 0)
                this.GroupIdFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "IDE"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_CustomerIdFilter()
        {
            ...
            // in the CustomerIdFilterQuickSelector
            ...
            CustomerIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.CustomerIdFilter, CustomerIdFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (CustomerIdFilterselectedFilterItemList == null || CustomerIdFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in CustomerIdFilterselectedFilterItemList)
                {
            	  
                    wc.iOR(CustomersTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, item);                  
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList CustomerIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.CustomerIdFilter, null);
            string CustomerIdFilterSessionString = "";
            if (CustomerIdFilterselectedFilterItemList != null){
                foreach (string item in CustomerIdFilterselectedFilterItemList){
                    CustomerIdFilterSessionString = String.Concat(CustomerIdFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.CustomerIdFilter, CustomerIdFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("CustomerIdFilter_Ajax", CustomerIdFilterSessionString);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["SitesTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["SitesTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Sites" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../Sites/Add-Sites.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "SitesTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "SitesTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(CustomerIdFilter))
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = SitesTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             SitesTable.SiteName,
             SitesTable.GroupId,
             SitesTable.CustomerId,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(SitesTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(SitesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(SitesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(SitesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(SitesTable.SiteName, "Default"));
             data.ColumnList.Add(new ExcelColumn(SitesTable.GroupId, "Default"));
             data.ColumnList.Add(new ExcelColumn(SitesTable.CustomerId, "Default"));
              ...
              {
                val = SitesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-Sites-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Sites";
                // If Group-By-Sites-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(SitesTable.SiteName.Name, ReportEnum.Align.Left, "${SiteName}", ReportEnum.Align.Left, 28);
                 report.AddColumn(SitesTable.GroupId.Name, ReportEnum.Align.Left, "${GroupId}", ReportEnum.Align.Left, 28);
                 report.AddColumn(SitesTable.CustomerId.Name, ReportEnum.Align.Left, "${CustomerId}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = SitesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = SitesTable.GetRecordCount(joinFilter,whereClause);
                SitesRecord[] records = null;
                
                do
                {
                    
                    records = SitesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( SitesRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${SiteName}", record.Format(SitesTable.SiteName), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.GroupId)){
                                 report.AddData("${GroupId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = SitesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SitesTable.GroupId);
                                 _DFKA = SitesTable.GetDFKA(record.GroupId.ToString(), SitesTable.GroupId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  SitesTable.GroupId.IsApplyDisplayAs){
                                     report.AddData("${GroupId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${GroupId}", record.Format(SitesTable.GroupId), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CustomerId)){
                                 report.AddData("${CustomerId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = SitesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SitesTable.CustomerId);
                                 _DFKA = SitesTable.GetDFKA(record.CustomerId.ToString(), SitesTable.CustomerId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  SitesTable.CustomerId.IsApplyDisplayAs){
                                     report.AddData("${CustomerId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${CustomerId}", record.Format(SitesTable.CustomerId), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-Sites-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Sites";
                // If Group-By-Sites-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in SitesTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(SitesTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (SitesTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && SitesTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(SitesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(SitesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = SitesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  SitesRecord[] DataSource {
            ...
            get {
                return (SitesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector CustomerIdFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerIdFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal CustomerIdLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerIdLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                SitesTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IDE"));
                }
        ...
        public virtual SitesTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual SitesTableControlRow[] GetSelectedRecordControls()
        {
        
            return (SitesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Group_By_Sites_Table.SitesTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            SitesTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IDE"));
            }
            
            foreach (SitesTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual SitesTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "SitesTableControlRow");
	          List<SitesTableControlRow> list = new List<SitesTableControlRow>();
	          foreach (SitesTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
