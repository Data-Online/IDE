...
// This file implements the code-behind class for Edit_Sites_Table.aspx.
// Edit_Sites_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Sites_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Sites_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Sites_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSitesTableControl()
        {
            SetSitesTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Edit_Sites_Table.SitesTableControl SitesTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "SitesTableControl":
                 SetSitesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.SitesTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IDE.UI.Controls.Edit_Sites_Table.SitesTableControl control = new IDE.UI.Controls.Edit_Sites_Table.SitesTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSitesTableControl_Base()           
        
        {        
            if (SitesTableControl.Visible)
            {
                SitesTableControl.LoadData();
                SitesTableControl.DataBind();
            }
        }
