...
// This file implements the code-behind class for Add_Sites.aspx.
// Add_Sites.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Sites
        : BaseApplicationPage
// Code-behind class for the Add_Sites page.
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Add_Sites.SitesRecordControl SitesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Sites");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.SitesRecordControl != null && this.SitesRecordControl.DataSource != null)
                  {
                        id = this.SitesRecordControl.DataSource.GetValue(this.SitesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.SitesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.SitesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.SitesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.SitesRecordControl.DataSource.GetValue(this.SitesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
