...
// Add_Sites.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Add_Sites
{
...
// Base class for the SitesRecordControl control on the Add_Sites page.
...
public class BaseSitesRecordControl : IDE.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (SitesRecord)SitesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in SitesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Sites"];
            ...
            HttpContext.Current.Session["QueryString in Add-Sites"] = recId;
