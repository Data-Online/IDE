...
// Edit_Sites_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Edit_Sites_Table
{
...
// Base class for the SitesTableControlRow control on the Edit_Sites_Table page.
...
public class BaseSitesTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.CustomerId.SelectedIndexChanged += CustomerId_SelectedIndexChanged;                  
        ...
        public virtual void SetCustomerId()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.CustomerId.ID))
            {
                if (this.PreviousUIData[this.CustomerId.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.CustomerId.ID].ToString();
            }
            
            
            // Set the CustomerId QuickSelector on the webpage with value from the
            ...
            // this.CustomerId is the ASP:QuickSelector on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.CustomerIdSpecified)
            {
                ...
                selectedValue = this.DataSource.CustomerId.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SitesTable.CustomerId.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.CustomerId, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "IDE"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.CustomerId.SetFieldMaxLength(50);
            ...
            if (selectedValue != null &&
                ...
                !MiscUtils.SetSelectedDisplayText(this.CustomerId, selectedValue))
            {

                // construct a whereclause to query a record with DatabaseCimscoPortal%dbo.Customers.CustomerId = selectedValue
                    
                CompoundFilter filter2 = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
                WhereClause whereClause2 = new WhereClause();
                filter2.AddFilter(new BaseClasses.Data.ColumnValueFilter(CustomersTable.CustomerId, selectedValue, BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        MiscUtils.ResetSelectedItem(this.CustomerId, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
              ...
              url += "?Target=" + this.CustomerId.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustomerName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustomerId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.CustomerId.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(CustomerId.AutoPostBack).ToLower() + ", event); return false;";
        ...
        public virtual void SetGroupId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SitesTable.GroupId.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.GroupId, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "IDE"), "--PLEASE_SELECT--"));
                ...
                !MiscUtils.SetSelectedDisplayText(this.GroupId, selectedValue))
            {
                ...
                // construct a whereclause to query a record with DatabaseCimscoPortal%dbo.Groups.GroupId = selectedValue
        ...
        {
         // Retrieve the value entered by the user on the CustomerId ASP:QuickSelector, and
            // save it into the CustomerId field in DataSource DatabaseCimscoPortal%dbo.Sites record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.CustomerId), SitesTable.CustomerId);			
        ...
        public virtual void GetGroupId()
        {
         // Retrieve the value entered by the user on the GroupId ASP:QuickSelector, and
            // save it into the GroupId field in DataSource DatabaseCimscoPortal%dbo.Sites record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.GroupId), SitesTable.GroupId);			
        ...
        public virtual void GetSiteName()
        {
            ...
            // save it into the SiteName field in DataSource DatabaseCimscoPortal%dbo.Sites record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.SiteName.Text, SitesTable.SiteName);							
      ...
      // To customize, override this method in SitesTableControlRow.
        ...
        SitesTableControl tc= ((SitesTableControl)MiscUtils.GetParentControlObject(this, "SitesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((SitesTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Sites/Show-Sites.aspx?Sites={PK}";
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector CustomerId {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerId");
            }
        }              
...
// Base class for the SitesTableControl control on the Edit_Sites_Table page.
...
public class BaseSitesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      SitesRecord rec = new SitesRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.CustomerId)) {
                            rec.Parse(recControl.CustomerId.SelectedItem.Value, SitesTable.CustomerId);
                        }
                        if (MiscUtils.IsValueSelected(recControl.GroupId)) {
                            rec.Parse(recControl.GroupId.SelectedItem.Value, SitesTable.GroupId);
                        }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("SitesTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (SitesTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        SitesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual SitesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SitesTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_Sites_Table.SitesTableControlRow")));
