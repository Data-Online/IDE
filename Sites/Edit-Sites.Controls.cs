...
// Edit_Sites.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Edit_Sites
{
...
// Base class for the InvoiceSummariesTableControlRow control on the Edit_Sites page.
...
public class BaseInvoiceSummariesTableControlRow : IDE.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.SiteName1.TextChanged += SiteName1_TextChanged;
        ...
        public virtual void SetPeriodEnd()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.PeriodEnd.ID))
            {
            
                this.PeriodEnd.Text = this.PreviousUIData[this.PeriodEnd.ID].ToString();
        ...
        public virtual void SetPeriodStart()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.PeriodStart.ID))
            {
            
                this.PeriodStart.Text = this.PreviousUIData[this.PeriodStart.ID].ToString();
        ...
        public virtual void SetSiteName1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SiteName1.ID))
            {
            
                this.SiteName1.Text = this.PreviousUIData[this.SiteName1.ID].ToString();
            ...
            // this.DataSource is the DatabaseCimscoPortal%dbo.InvoiceSummaries record retrieved from the database.
            // this.SiteName1 is the ASP:TextBox on the webpage.
        ...
        public virtual void GetSiteName1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.SiteName1.Text, InvoiceSummariesTable.SiteName);							
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void SiteName1_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox SiteName1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SiteName1");
            }
        }
...
// Base class for the InvoiceSummariesTableControl control on the Edit_Sites page.
...
public class BaseInvoiceSummariesTableControl : IDE.UI.BaseApplicationTableControl
{
    ...
    IDE.UI.Controls.Edit_Sites.SitesRecordControl sitesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "SitesRecordControl") as IDE.UI.Controls.Edit_Sites.SitesRecordControl);
      ...
      InvoiceSummariesRecord rec = new InvoiceSummariesRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Period End {Txt:Ascending}"), "PeriodEnd Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Period End {Txt:Descending}"), "PeriodEnd Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Period Start {Txt:Ascending}"), "PeriodStart Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Period Start {Txt:Descending}"), "PeriodStart Desc"));
...
#region "Helper Functions"
        ...
        public virtual InvoiceSummariesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InvoiceSummariesTableControlRow[])(selectedList.ToArray(Type.GetType("IDE.UI.Controls.Edit_Sites.InvoiceSummariesTableControlRow")));
...
// Base class for the SitesRecordControl control on the Edit_Sites page.
...
public class BaseSitesRecordControl : IDE.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in SitesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Sites"] = recId;
