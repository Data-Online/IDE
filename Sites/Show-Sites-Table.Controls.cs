...
// Show_Sites_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_Sites_Table
{
...
// Base class for the SitesTableControlRow control on the Show_Sites_Table page.
...
// Base class for the SitesTableControl control on the Show_Sites_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Sites-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Sites";
                // If Show-Sites-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Sites-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Sites";
                // If Show-Sites-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual SitesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SitesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_Sites_Table.SitesTableControlRow")));
