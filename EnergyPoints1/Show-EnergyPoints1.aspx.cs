...
// This file implements the code-behind class for Show_EnergyPoints1.aspx.
// Show_EnergyPoints1.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_EnergyPoints1
        : BaseApplicationPage
// Code-behind class for the Show_EnergyPoints1 page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_EnergyPoints1()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEnergyPoints1RecordControl()
        {
            SetEnergyPoints1RecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Show_EnergyPoints1.EnergyPoints1RecordControl EnergyPoints1RecordControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EnergyPoints1RecordControl":
                 SetEnergyPoints1RecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EnergyPoints1RecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEnergyPoints1RecordControl_Base()           
        
        {        
            if (EnergyPoints1RecordControl.Visible)
            {
                EnergyPoints1RecordControl.LoadData();
                EnergyPoints1RecordControl.DataBind();
            }
        }
