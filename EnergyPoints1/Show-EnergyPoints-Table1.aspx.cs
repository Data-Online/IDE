...
// This file implements the code-behind class for Show_EnergyPoints_Table1.aspx.
// Show_EnergyPoints_Table1.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_EnergyPoints_Table1
        : BaseApplicationPage
// Code-behind class for the Show_EnergyPoints_Table1 page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_EnergyPoints_Table1()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEnergyPoints1TableControl()
        {
            SetEnergyPoints1TableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public IDE.UI.Controls.Show_EnergyPoints_Table1.EnergyPoints1TableControl EnergyPoints1TableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EnergyPoints1TableControl":
                 SetEnergyPoints1TableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EnergyPoints1TableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        IDE.UI.Controls.Show_EnergyPoints_Table1.EnergyPoints1TableControl control = new IDE.UI.Controls.Show_EnergyPoints_Table1.EnergyPoints1TableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEnergyPoints1TableControl_Base()           
        
        {        
            if (EnergyPoints1TableControl.Visible)
            {
                EnergyPoints1TableControl.LoadData();
                EnergyPoints1TableControl.DataBind();
            }
        }
