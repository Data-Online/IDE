...
// Show_EnergyPoints_Table1.aspx page.  The Row or RecordControl classes are the 
...
namespace IDE.UI.Controls.Show_EnergyPoints_Table1
{
...
// Base class for the EnergyPoints1TableControlRow control on the Show_EnergyPoints_Table1 page.
// Do not modify this class. Instead override any method in EnergyPoints1TableControlRow.
public class BaseEnergyPoints1TableControlRow : IDE.UI.BaseApplicationRecordControl
{
        public BaseEnergyPoints1TableControlRow()
        {
        ...
        // To customize, override this method in EnergyPoints1TableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseCimscoNZ%dbo.EnergyPoints record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = EnergyPoints1Table.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseEnergyPoints1TableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new EnergyPoints1Record();
        ...
        public virtual void SetConnectionNumber()
        {
            ...
            // DatabaseCimscoNZ%dbo.EnergyPoints database record.

            // this.DataSource is the DatabaseCimscoNZ%dbo.EnergyPoints record retrieved from the database.
            ...
            if (this.DataSource != null && this.DataSource.ConnectionNumberSpecified) {
               ...
               string formattedValue = this.DataSource.Format(EnergyPoints1Table.ConnectionNumber);
              ...
              this.ConnectionNumber.Text = EnergyPoints1Table.ConnectionNumber.Format(EnergyPoints1Table.ConnectionNumber.DefaultValue);
        ...
        public virtual void SetEnabled0()
        {
            
                    
            // Set the Enabled Literal on the webpage with value from the
            // DatabaseCimscoNZ%dbo.EnergyPoints database record.

            // this.DataSource is the DatabaseCimscoNZ%dbo.EnergyPoints record retrieved from the database.
            // this.Enabled0 is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.Enabled0Specified) {
                								
                // If the Enabled is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(EnergyPoints1Table.Enabled0);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.Enabled0.Text = formattedValue;
                   
            } 
            
            else {
            
                // Enabled is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.Enabled0.Text = EnergyPoints1Table.Enabled0.Format(EnergyPoints1Table.Enabled0.DefaultValue);
            		
            }
            
            // If the Enabled is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Enabled0.Text == null ||
                this.Enabled0.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.Enabled0.Text = "&nbsp;";
            }
        ...
        public virtual void SetSiteId()
        {
            ...
            if (this.DataSource != null && this.DataSource.SiteIdSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = EnergyPoints1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyPoints1Table.SiteId);
               if(_isExpandableNonCompositeForeignKey &&EnergyPoints1Table.SiteId.IsApplyDisplayAs)
                                  
                     formattedValue = EnergyPoints1Table.GetDFKA(this.DataSource.SiteId.ToString(),EnergyPoints1Table.SiteId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(EnergyPoints1Table.SiteId);
              ...
              this.SiteId.Text = EnergyPoints1Table.SiteId.Format(EnergyPoints1Table.SiteId.DefaultValue);
        ...
        public virtual void SetSupplierId()
        {
            ...
            if (this.DataSource != null && this.DataSource.SupplierIdSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = EnergyPoints1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyPoints1Table.SupplierId);
               if(_isExpandableNonCompositeForeignKey &&EnergyPoints1Table.SupplierId.IsApplyDisplayAs)
                                  
                     formattedValue = EnergyPoints1Table.GetDFKA(this.DataSource.SupplierId.ToString(),EnergyPoints1Table.SupplierId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(EnergyPoints1Table.SupplierId);
              ...
              this.SupplierId.Text = EnergyPoints1Table.SupplierId.Format(EnergyPoints1Table.SupplierId.DefaultValue);
        ...
        public virtual void SetEnabledLabel()
                  {
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((EnergyPoints1TableControl)MiscUtils.GetParentControlObject(this, "EnergyPoints1TableControl")).DataChanged = true;
                ((EnergyPoints1TableControl)MiscUtils.GetParentControlObject(this, "EnergyPoints1TableControl")).ResetData = true;
            }
        ...
        public virtual void GetEnabled0()
        {
      ...
      // To customize, override this method in EnergyPoints1TableControlRow.
         ...
         
        {
            ...
            bool hasFiltersEnergyPoints1TableControl = false;
            hasFiltersEnergyPoints1TableControl = hasFiltersEnergyPoints1TableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          EnergyPoints1Table.DeleteRecord(pkValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseEnergyPoints1TableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseEnergyPoints1TableControlRow_Rec"] = value;
            }
        }
        
        public EnergyPoints1Record DataSource {
            get {
                return (EnergyPoints1Record)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Enabled0 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Enabled0");
            }
        }
            
        public System.Web.UI.WebControls.Literal EnabledLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "EnabledLabel");
            }
        }
    ...
    EnergyPoints1Record rec = null;
        ...
        public virtual EnergyPoints1Record GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return EnergyPoints1Table.GetRecord(this.RecordUniqueId, true);
...
// Base class for the EnergyPoints1TableControl control on the Show_EnergyPoints_Table1 page.
// Do not modify this class. Instead override any method in EnergyPoints1TableControl.
public class BaseEnergyPoints1TableControl : IDE.UI.BaseApplicationTableControl
{
         
       public BaseEnergyPoints1TableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(IDE.Business.EnergyPoints1Record);
                      this.DataSource = (EnergyPoints1Record[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (EnergyPoints1TableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(IDE.Business.EnergyPoints1Record);
                    this.DataSource = (EnergyPoints1Record[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual EnergyPoints1Record[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(EnergyPoints1Table.Column1, true);          
            // selCols.Add(EnergyPoints1Table.Column2, true);          
            // selCols.Add(EnergyPoints1Table.Column3, true);          
                  ...
                  
            {
                ...
                return EnergyPoints1Table.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                EnergyPoints1Table databaseTable = new EnergyPoints1Table();
                ...
                return (recList.ToArray(typeof(EnergyPoints1Record)) as EnergyPoints1Record[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return EnergyPoints1Table.GetRecordCount(join, where);
            else
            {
                EnergyPoints1Table databaseTable = new EnergyPoints1Table();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "EnergyPoints1TableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            EnergyPoints1TableControlRow recControl = (EnergyPoints1TableControlRow)(repItem.FindControl("EnergyPoints1TableControlRow"));
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(EnergyPoints1Table.SiteId, this.DataSource);
            this.Page.PregetDfkaRecords(EnergyPoints1Table.SupplierId, this.DataSource);
        }
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for EnergyPoints1TableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (EnergyPoints1TableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            EnergyPoints1Table.Instance.InnerFilter = null;
      ...
      cols.Add(EnergyPoints1Table.SupplierId, true);
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.SupplierIdFilter)) {
                ...
                foreach (ListItem item in this.SupplierIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(EnergyPoints1Table.SupplierId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String SupplierIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "SupplierIdFilter_Ajax"];
        ...
        if (SupplierIdFilterSelectedValue != null){
                        ...
                        foreach (string item in SupplierIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(EnergyPoints1Table.SupplierId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            IDE.Business.EnergyPoints1Record[] recordList  = EnergyPoints1Table.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (EnergyPoints1Record rec in recordList ){
                ...
                resultItem = rec.Format(EnergyPoints1Table.SupplierId);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(EnergyPoints1Table.SupplierId.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, EnergyPoints1Table.SupplierId.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      EnergyPoints1Record rec = new EnergyPoints1Record();
        
                        if (recControl.ConnectionNumber.Text != "") {
                            rec.Parse(recControl.ConnectionNumber.Text, EnergyPoints1Table.ConnectionNumber);
                  }
                
                        if (recControl.Enabled0.Text != "") {
                            rec.Parse(recControl.Enabled0.Text, EnergyPoints1Table.Enabled0);
                  }
                
                        if (recControl.SiteId.Text != "") {
                            rec.Parse(recControl.SiteId.Text, EnergyPoints1Table.SiteId);
                  }
                
                        if (recControl.SupplierId.Text != "") {
                            rec.Parse(recControl.SupplierId.Text, EnergyPoints1Table.SupplierId);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new EnergyPoints1Record());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(IDE.Business.EnergyPoints1Record);
                this.DataSource = (EnergyPoints1Record[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(EnergyPoints1TableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(EnergyPoints1TableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetSupplierIdFilter()
        {
            ...
            this.PopulateSupplierIdFilter(MiscUtils.GetSelectedValueList(this.SupplierIdFilter, SupplierIdFilterselectedFilterItemList), 500);
              ...
              string url = this.ModifyRedirectUrl("../EnergySuppliers1/EnergySuppliers-QuickSelector1.aspx", "", true);
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Connection Number {Txt:Ascending}"), "ConnectionNumber Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Connection Number {Txt:Descending}"), "ConnectionNumber Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Enabled {Txt:Ascending}"), "Enabled Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Enabled {Txt:Descending}"), "Enabled Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Site {Txt:Ascending}"), "SiteId Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Site {Txt:Descending}"), "SiteId Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Supplier {Txt:Ascending}"), "SupplierId Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Supplier {Txt:Descending}"), "SupplierId Desc"));
                    ...
                    
        {
            ...
            EnergySuppliers1Record[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = EnergySuppliers1Table.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (EnergySuppliers1Record itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.SupplierIdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.SupplierIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = EnergyPoints1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyPoints1Table.SupplierId);
                                if(_isExpandableNonCompositeForeignKey && EnergyPoints1Table.SupplierId.IsApplyDisplayAs)
                                     fvalue = EnergyPoints1Table.GetDFKA(itemValue, EnergyPoints1Table.SupplierId);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(EnergySuppliers1Table.SupplierName);
        ...
        public virtual WhereClause CreateWhereClause_SupplierIdFilter()
        {
            ...
            else            
            {
                foreach (string item in SupplierIdFilterselectedFilterItemList)
                {
                    ...
                    wc.iOR(EnergySuppliers1Table.SupplierId, BaseFilter.ComparisonOperator.EqualsTo, item);                  
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["EnergyPoints1TableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["EnergyPoints1TableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=EnergyPoints1" ;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "EnergyPoints1TableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "EnergyPoints1TableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = EnergyPoints1Table.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             EnergyPoints1Table.ConnectionNumber,
             EnergyPoints1Table.SiteId,
             EnergyPoints1Table.SupplierId,
             EnergyPoints1Table.Enabled0,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(EnergyPoints1Table.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(EnergyPoints1Table.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(EnergyPoints1Table.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(EnergyPoints1Table.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(EnergyPoints1Table.ConnectionNumber, "Default"));
             data.ColumnList.Add(new ExcelColumn(EnergyPoints1Table.SiteId, "Default"));
             data.ColumnList.Add(new ExcelColumn(EnergyPoints1Table.SupplierId, "Default"));
             data.ColumnList.Add(new ExcelColumn(EnergyPoints1Table.Enabled0, "Default"));
              ...
              {
                val = EnergyPoints1Table.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyPoints-Table1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyPoints";
                // If Show-EnergyPoints-Table1.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(EnergyPoints1Table.ConnectionNumber.Name, ReportEnum.Align.Left, "${ConnectionNumber}", ReportEnum.Align.Left, 24);
                 report.AddColumn(EnergyPoints1Table.SiteId.Name, ReportEnum.Align.Left, "${SiteId}", ReportEnum.Align.Left, 28);
                 report.AddColumn(EnergyPoints1Table.SupplierId.Name, ReportEnum.Align.Left, "${SupplierId}", ReportEnum.Align.Left, 28);
                 report.AddColumn(EnergyPoints1Table.Enabled0.Name, ReportEnum.Align.Left, "${Enabled0}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = EnergyPoints1Table.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = EnergyPoints1Table.GetRecordCount(joinFilter,whereClause);
                EnergyPoints1Record[] records = null;
                
                do
                {
                    
                    records = EnergyPoints1Table.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( EnergyPoints1Record record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${ConnectionNumber}", record.Format(EnergyPoints1Table.ConnectionNumber), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.SiteId)){
                                 report.AddData("${SiteId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = EnergyPoints1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyPoints1Table.SiteId);
                                 _DFKA = EnergyPoints1Table.GetDFKA(record.SiteId.ToString(), EnergyPoints1Table.SiteId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  EnergyPoints1Table.SiteId.IsApplyDisplayAs){
                                     report.AddData("${SiteId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${SiteId}", record.Format(EnergyPoints1Table.SiteId), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.SupplierId)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = EnergyPoints1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(EnergyPoints1Table.SupplierId);
                                 _DFKA = EnergyPoints1Table.GetDFKA(record.SupplierId.ToString(), EnergyPoints1Table.SupplierId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  EnergyPoints1Table.SupplierId.IsApplyDisplayAs){
                                     report.AddData("${SupplierId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${SupplierId}", record.Format(EnergyPoints1Table.SupplierId), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${Enabled0}", record.Format(EnergyPoints1Table.Enabled0), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-EnergyPoints-Table1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "EnergyPoints";
                // If Show-EnergyPoints-Table1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in EnergyPoints1Table.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(EnergyPoints1Table.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (EnergyPoints1Table.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && EnergyPoints1Table.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(EnergyPoints1Table.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(EnergyPoints1Table.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = EnergyPoints1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  EnergyPoints1Record[] DataSource {
            ...
            get {
                return (EnergyPoints1Record[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                EnergyPoints1TableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual EnergyPoints1TableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual EnergyPoints1TableControlRow[] GetSelectedRecordControls()
        {
        
            return (EnergyPoints1TableControlRow[])((new ArrayList()).ToArray(Type.GetType("IDE.UI.Controls.Show_EnergyPoints_Table1.EnergyPoints1TableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            EnergyPoints1TableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "IDE"));
            }
            
            foreach (EnergyPoints1TableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual EnergyPoints1TableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "EnergyPoints1TableControlRow");
	          List<EnergyPoints1TableControlRow> list = new List<EnergyPoints1TableControlRow>();
	          foreach (EnergyPoints1TableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
